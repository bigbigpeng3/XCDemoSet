 ...
 */
public class MyTickerView extends View {
    ...
    private final MyTickerColumnManager columnManager = new MyTickerColumnManager(metrics);
    ...
    public MyTickerView(Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public MyTickerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public MyTickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MyTickerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        borderPaint.setTypeface(typeface);
        onTextPaintMeasurementChanged();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.e("MyTickerView", "onMeasure = " + desiredWidth);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        borderPaint.setColor(getContext().getResources().getColor(R.color.ticker_border_color));
...
//        borderPaint.setTypeface(TextTypeUtils.getRoundTypeFace(getContext()));
//        textPaint.setTypeface(TextTypeUtils.getRoundTypeFace(getContext()));

        columnManager.draw(canvas, textPaint, borderPaint, mPadding);
...
//        setAnimateMeasurementChange(true);
    ...
    private void realignAndClipCanvasForGravity(Canvas canvas) {
        final float currentWidth = columnManager.getCurrentWidth() + (mPadding * columnManager.tickerColumns.size());
