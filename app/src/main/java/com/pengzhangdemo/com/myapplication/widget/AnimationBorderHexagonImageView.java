...
public class AnimationBorderHexagonImageView extends ImageView {
    ...
    public AnimationBorderHexagonImageView(Context context) {
        super(context);
    }

    public AnimationBorderHexagonImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AnimationBorderHexagonImageView(Context context, AttributeSet attrs, int defStyle) {
