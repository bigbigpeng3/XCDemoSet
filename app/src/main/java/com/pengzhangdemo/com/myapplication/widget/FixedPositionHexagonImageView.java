...
public class FixedPositionHexagonImageView extends ImageView {
    ...
    public FixedPositionHexagonImageView(Context context) {
        super(context);
    }

    public FixedPositionHexagonImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FixedPositionHexagonImageView(Context context, AttributeSet attrs, int defStyle) {
