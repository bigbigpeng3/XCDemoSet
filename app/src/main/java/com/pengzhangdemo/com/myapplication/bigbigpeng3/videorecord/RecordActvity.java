package com.pengzhangdemo.com.myapplication.bigbigpeng3.videorecord;
...
* @version V1.0 
*/
public class RecordActvity extends Activity {

	private static final String TAG = "BigBigPengMainActivity";
