 ...
 * 绘制多边形
 */
public class FixedPathMultiView extends View {
    ...
    public FixedPathMultiView(Context context) {
        this(context, null);
    }

    public FixedPathMultiView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FixedPathMultiView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (animator == null) {
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    FixedPathMultiView.this.postInvalidate();
                }
            });
