...
public class MeHexagonImageView extends ImageView {
    ...
    public MeHexagonImageView(Context context) {
        super(context);
    }

    public MeHexagonImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MeHexagonImageView(Context context, AttributeSet attrs, int defStyle) {
...
//        drawRadius(canvas,mBorderRadius,mBorderPaint);
        ...
        System.out.println("double radian30 = 30 * Math.PI / 180; = " + radian30);
        System.out.println("double radian60 = 60 * Math.PI / 180;  = " + radian60);
        ...
        float c = (mHeight - 2 * b1) / 2;

        System.out.println("getWidth() = " + getWidth() + ", getHeight() = " + mHeight);

        System.out.println(" float a1 = (float) (mDrawableRadius * Math.sin(radian30)); = " + a1);
        System.out.println(" float b1 = (float) (mDrawableRadius * Math.cos(radian30)); = " + b1);
        System.out.println(" float c = (mHeight - 2 * b1) / 2; = " + c);
        ...
        System.out.println("path.moveTo(getWidth(), getHeight() / 2); getWidth() =  " + getWidth() + " getHeight() / 2 =  " + getHeight() / 2);


        path.lineTo(getWidth() - a1, getHeight() - c);

        System.out.println("path.lineTo(getWidth() - a1, getHeight() - c); getWidth() - a1 =  " + (getWidth() - a1) + " getHeight() - c =  " + (getHeight() - c));

        path.lineTo(getWidth() - a1 - mLenght, getHeight() - c);

        System.out.println("path.lineTo(getWidth() - a1 - mLenght, getHeight() - c); getWidth() - a1 - mLenght =  " + (getWidth() - a1 - mLenght) + " getHeight() - c =  " + (getHeight() - c));


        path.lineTo(0, getHeight() / 2);

        System.out.println("path.lineTo(0, getHeight() / 2)");

        path.lineTo(a1, c);

        System.out.println("path.lineTo(a1, c); a1 = " + a1 + ",c = " + c);


        path.lineTo(getWidth() - a1, c);

        System.out.println("path.lineTo(getWidth() - a1, c); getWidth() - a1 = " + (getWidth() - a1) + ",c = " + c);
