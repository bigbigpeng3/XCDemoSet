 ...
 * 绘制多边形 边缘需要有一个动画效果
 */
public class FixedHexoRoundRecyclePathView extends View {
    ...
    public FixedHexoRoundRecyclePathView(Context context) {
        this(context, null);
    }

    public FixedHexoRoundRecyclePathView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FixedHexoRoundRecyclePathView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                Color.TRANSPARENT, Color.YELLOW, Color.YELLOW, Color.YELLOW },
//                new float[] { 0, .1F, .8F, .9F }, Shader.TileMode.CLAMP);
        ...
        if (animator == null) {
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    FixedHexoRoundRecyclePathView.this.postInvalidate();
                }
            });
